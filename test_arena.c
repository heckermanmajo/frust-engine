...
// todo: add a resize -> realloc

ARENA(ExampleType, 100)
...
int main() {
    ...
    // get one
    ExampleType* e = ArenaOfExampleType_get_first_dead_one_and_set_back_to_live(a);
    ...
    ExampleType* e2 = ArenaOfExampleType_get_first_dead_one_and_set_back_to_live(a);
    assert(e2->index == 47);
